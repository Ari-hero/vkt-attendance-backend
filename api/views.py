...
class EmployeeListCreateView(generics.ListCreateAPIView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        if err_response:
            # Allow web dashboard without device headers if origin header exists
...
class ExportExcelReportView(APIView):
    """
    Generates Excel report sorted by Employee Name and Date.
    Columns: Employee ID, Name, Date, First IN, Last OUT, Total Punches, Status (Present/Absent).
    """
